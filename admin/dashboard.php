                        ...
                        <table class="table" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    {
                                        $ord_date = strtotime($row["Rev_Sdate"]);
                                        $ford_date = date("d-m-Y",$ord_date);

                                        $ord_date1 = strtotime($row["Rev_Edate"]);
                                        $ford_date1 = date("d-m-Y",$ord_date1);

                                        echo '
                                            <tr>
                                                <td>'.$row["Rev_roomno"].'</td>
                                                <td>'.$row["Rev_roomtype"].'</td>
                                                <td class="text-success">'.$ford_date.'</td>
                                                <td class="text-danger">'.$ford_date1.'</td>
