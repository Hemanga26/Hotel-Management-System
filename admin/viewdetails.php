                ...
                <div class="card-body" id="invoice">
                    ...
                    <?php
                        if(isset($_POST["View"]))
                        {
                            ...
                            $ord_date8 = strtotime($row["Rev_Sdate"]);
                            $ford_date8 = date("d-m-Y",$ord_date8);

                            $ord_date9 = strtotime($row["Rev_Edate"]);
                            $ford_date9 = date("d-m-Y",$ord_date9);
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="text-success" style="font-size: 24px !important;">'.$ford_date8.'</div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="RoomNumber" class="col-sm-2 col-form-label">CheckOUT</label>
                                <div class="col-sm-10">
                                    <div class="text-danger" style="font-size: 24px !important;">'.$ford_date9.'</div>
                                </div>
                            </div>
                            <div class="form-group row">
