                        ...
                        <table class="table" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    {
                                        $ord_date2 = strtotime($row["Rev_Sdate"]);
                                        $ford_date2 = date("d-m-Y",$ord_date2);

                                        $ord_date3 = strtotime($row["Rev_Edate"]);
                                        $ford_date3 = date("d-m-Y",$ord_date3);
                                        ...
                                        echo '
                                            <tr>
                                                ...
                                                <td class="text-success">'.$ford_date2.'</td>
                                                <td class="text-danger">'.$ford_date3.'</td>
