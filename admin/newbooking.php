                ...
                <div class="card-body">
                    ...
                    <?php
                        if(isset($_POST["View"]))
                        {
                            ...
                            $ord_date4 = strtotime($row["Rev_Sdate"]);
                            $ford_date4 = date("d-m-Y",$ord_date4);

                            $ord_date5 = strtotime($row["Rev_Edate"]);
                            $ford_date5 = date("d-m-Y",$ord_date5);
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="text-success" style="font-size: 24px !important;">'.$ford_date4.'</div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="RoomNumber" class="col-sm-2 col-form-label">CheckOUT</label>
                                <div class="col-sm-10">
                                    <div class="text-danger" style="font-size: 24px !important;">'.$ford_date5.'</div>
                                </div>
                            </div>
                            <div class="form-group row">
